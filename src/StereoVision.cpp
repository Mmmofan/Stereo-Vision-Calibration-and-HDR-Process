...
void StereoVision::getQMatrix(void) {
    ...
    std::cout <<  "Q matrix is: " <<std::endl  <<m_qMatrix << std::endl;
...
void StereoVision::convertColourSpaces(left_right lr) {
    ...
    case LEFT:
        ...
        cv::morphologyEx(m_leftThresholdFrame, m_leftThresholdFrame, cv::MORPH_OPEN, strEl);
        cv::morphologyEx(m_leftThresholdFrame, m_leftThresholdFrame, cv::MORPH_CLOSE, strEl);
    ...
    case RIGHT:
        ...
        cv::morphologyEx(m_rightThresholdFrame, m_rightThresholdFrame, cv::MORPH_OPEN, strEl);
        cv::morphologyEx(m_rightThresholdFrame, m_rightThresholdFrame, cv::MORPH_CLOSE, strEl);
